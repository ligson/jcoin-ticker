...
electron.contextBridge.exposeInMainWorld("storeAPI", {
  get: (key, defaultValue) => electron.ipcRenderer.invoke("store-get", key, defaultValue),
  ...
  reset: (key, defaultValue) => electron.ipcRenderer.invoke("store-reset", key, defaultValue),
